...
class PromotersControllerTest < ActionController::TestCase
  ...
  test "should create promoter" do
    assert_difference('Promoter.count') do
      post :create, promoter: { email: @promoter.email, name: @promoter.name, phone: @promoter.phone, picture: @promoter.picture }
    end
  ...
  test "should update promoter" do
    patch :update, id: @promoter, promoter: { email: @promoter.email, name: @promoter.name, phone: @promoter.phone, picture: @promoter.picture }
    assert_redirected_to promoter_path(assigns(:promoter))
  end
