...
class DealTypesControllerTest < ActionController::TestCase
  ...
  test "should create deal_type" do
    assert_difference('DealType.count') do
      post :create, deal_type: { commision: @deal_type.commision, description: @deal_type.description, name: @deal_type.name }
    end
  ...
  test "should update deal_type" do
    patch :update, id: @deal_type, deal_type: { commision: @deal_type.commision, description: @deal_type.description, name: @deal_type.name }
    assert_redirected_to deal_type_path(assigns(:deal_type))
  end
